...
As implied in its name, the implementation of Triple P framework involves the collection of process-level (ethological) and perception-level (ethnographic) data (**Figure** \@ref(fig:concept)). Ethological approaches are widly used in the description and analysis of non-human animal behavior [@fragaszy2018]. new toolkit such as BORIS were introduced [@friard2016]
