...
As implied in its name, the implementation of Triple P framework involves the collection of process-level (ethological) and perception-level (ethnographic) data (**Figure** \@ref(fig:concept)), which is critical to address equifinality, one of daunting challenges faced in archaeological inference[@chami2015]. Equifinality refers to the phenomenon where a similar state or consequence can be achieved through multiple different paths.
