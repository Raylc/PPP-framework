...
In the past decades, actualistic experiments becomes more common [@liu2022]. Is RCT the golden standard of knowledge [@cartwright2007]. Variability as revealed in experiment is crucial and cannot be simply replaced by ethnographic records because the many paleolithic technological components are not displayed in contemporary non-industrial societies, which usually feature technological systems with ground stone artifacts as the target products [@stout2002; @arthur2018].
